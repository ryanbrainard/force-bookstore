...
As points of comparison, these same tests were run with DataNucleus+HSQLDB and Hibernate+HSQLDB and both tests
passed in both cases. The sections below detail the different configurations.
